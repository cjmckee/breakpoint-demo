 ...
 * Events related to the player's relationship with Coach Martinez
 */
...
export const coachEvents: StoryEvent[] = [
  {
    ...
    options: [],
    defaultOutcome: {
      resultText: 'You spend an hour with Coach Martinez discussing your goals and tennis philosophy. He shares valuable insights about the mental side of the game and proper training techniques.',
      effects: {
        statBoosts: { focus: 2, anticipation: 1 },
        moodChange: 15,
        energyChange: -10,
        relationshipChanges: { coach_martinez: 25 },
      },
    },
  },
    ...
    options: [
      {
        ...
        outcome: {
          resultText: 'You spend intensive sessions working on serve technique. Coach Martinez helps you generate more power while maintaining accuracy. Your serve becomes a real weapon.',
          effects: {
            statBoosts: { serve: 5, strength: 3 },
            moodChange: 10,
            energyChange: -20,
            relationshipChanges: { coach_martinez: 15 },
          },
        },
      },
      {
        ...
        outcome: {
          resultText: 'You work tirelessly on groundstroke mechanics. Coach Martinez refines your technique on both wings. Your forehand and backhand both show marked improvement.',
          effects: {
      ...
      },
      {
        ...
        outcome: {
          resultText: 'Coach Martinez introduces you to sports psychology techniques. You learn breathing exercises, visualization methods, and how to stay focused under pressure. The mental game is just as important as the physical.',
          effects: {
            statBoosts: { focus: 5, anticipation: 3, offensive: 2 },
            moodChange: 15,
            energyChange: -15,
            relationshipChanges: { coach_martinez: 20 },
          },
        },
      },
    ],
