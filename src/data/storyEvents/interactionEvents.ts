...
export const interactionEvents: StoryEvent[] = [
...

  {
    ...
    prerequisites: {},
    skippable: false,
    description: 'Keith has a plan. It involves binoculars and hiding behind a bush.',
    dialogue: [
      ['keith', ["Okay. I've been watching the other academy's players."]],
      ['player', ["You've been what?"]],
      ['keith', ["Recon! Come on. I found a good bush."]],
      [null, ["He is holding binoculars. They appear to be children's binoculars."]],
      [null, ["He zeroes in on a practice from the academy across the highway. The binoculars are showing a remarkably clear image."]],
      ['player', ["Honestly, I'm not sure how this is supposed to be helping."]],
      ['player', ['And about the bush. They can\'t see us anyway.']],
      ['keith', ['Voice memo 1624. They are practicing backhands again. Noting this appears to be important.']]
    ],
    characters: ['keith'],
    options: [],
    defaultOutcome: {
      resultText: ["You spend forty-five minutes crouched behind a hedge watching players from another academy do drills. Keith takes notes in a spiral notebook labeled 'TOP SECRET.' At least some of the notes you laid eyes on are just doodles. You do learn one thing: their best player has a very weak second serve."],
      effects: {
