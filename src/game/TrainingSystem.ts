...
const TRAINING_SESSION_CONFIGS: Record<TrainingSessionType, TrainingConfig> = {
  groundstroke_training: {
    ...
    description: 'Develop forehand technique with precise placement and topspin',
  },
  ...
  footwork_training: {
    ...
    description: 'Improve court coverage and movement to position for strong backhands',
  },
  sports_psychology: {
    ...
    description: 'Build mental focus and anticipation to neutralize opponents\' serves',
  },
  strength_training: {
    ...
    description: 'Build explosive forehand power and stamina for long matches',
  },
  overhead_academy: {
    ...
    description: 'Master the net game with overhead smashes, precise placement, and volleying',
  },
  return_rapidfire: {
  ...
  spin_specialist: {
    ...
    description: 'Master heavy topspin with a grinding backhand spin game',
  },
  remote_coaching: {
  ...
  touch_training: {
    ...
    description: 'Develop a deft slice and drop shot touch with quick recovery',
  },
};
