/**
 * Test script for Tennis Rally Analysis Sub-Agent
 *
 * This demonstrates the complete workflow:
 * 1. Create players with specific stats and playstyles
 * 2. Run a match simulation
 * 3. Export match data to JSON
 *
 * Run with: ts-node test/testRallyAnalysis.ts
 */
...
// Test Scenario: Aggressive vs Defensive playstyle matchup
console.log('\n📊 Creating test players...\n');

const aggressive = new PlayerProfile(
  'player_aggressive',
  'Aggressive Andy',
  {
    technical: {
...
const defensive = new PlayerProfile(
  'player_defensive',
  'Defensive Dan',
  {
    technical: {
...
// console.log('\n' + '='.repeat(80));
// console.log('TENNIS RALLY ANALYSIS SUB-AGENT PROMPT');
// console.log('='.repeat(80));
// console.log('\n📋 To analyze this match, copy the prompt below and invoke the');
// console.log('   Tennis Rally Analysis Expert sub-agent using the Task tool.\n');
// console.log('─'.repeat(80));
// console.log();

// const prompt = getTennisAnalysisPrompt(filePath);
// console.log(prompt);
